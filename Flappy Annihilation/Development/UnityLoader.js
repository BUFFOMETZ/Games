...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'html.data';
    var REMOTE_PACKAGE_BASE = 'html.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3508805;
      var PACKAGE_UUID = '8bc7eb4f-4596-4875-92c5-ed3832d78468';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 685503, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(685503, 686108, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(686108, 689552, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(689552, 2606208, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2606208, 3481180, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3481180, 3508805, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_html.data');

    };
    Module['addRunDependency']('datafile_html.data');
